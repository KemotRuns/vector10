...
<div class="methodology">
	...
	<p><strong>Public data</strong> — Grid carbon intensity and low-carbon electricity share (Ember), baseline water stress (WRI Aqueduct 4.0), workers' rights ratings (ITUC Global Rights Index), and EU export shares (UN Comtrade, HS 50–63).</p>
	...
	<p><strong>Vector10 assessments</strong> — CBAM, CSRD and EPR exposure tiers and Digital Product Passport readiness reflect our consultants' judgment of forward-looking regulatory exposure, anchored on each country's EU export dependence, energy base, and traceability infrastructure. CBAM does not yet cover textiles; the tier expresses exposure if scope extends as debated.</p>
	<p><strong>Composite scores</strong> — <strong>Footprint score</strong> (higher = cleaner): carbon 40%, water usage 20%, water stress 20%, low-carbon share 20%, min-max normalized. <strong>Compliance risk</strong> (higher = riskier): CSRD 25%, EPR 20%, CBAM 20%, DPP gap 20%, labor risk 15% — labor is included because forced-labor regulation (EU Forced Labour Regulation, US UFLPA) is compliance risk.</p>
