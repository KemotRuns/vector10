...
const countrySchema = z.object({
	...
	laborCostUsd: z.number().positive(),
	laborCostIndex: z.number().min(0).max(100),
	tariffEu: z.enum(['free', 'reduced', 'mfn', 'penalty']),
	tariffUs: z.enum(['free', 'reduced', 'mfn', 'penalty']),
	uflpaExposure: tierSchema,
	leadEu: z.enum(['near', 'mid', 'far']),
	leadUs: z.enum(['near', 'mid', 'far']),
