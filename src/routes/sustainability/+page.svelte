<script lang="ts">
	...
	import type { ProducerRegion, SustainabilityMetric } from '$lib/types/sustainability';
	import { REGION_COLORS, METRIC_LABELS, METRIC_UNITS } from '$lib/types/sustainability';
